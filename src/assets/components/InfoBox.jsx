            ...
            <div className="flex flex-col font-[sans-serif] p-4">
              <div className="max-w-sm w-full mx-auto border border-gray-300 rounded-xl p-6 py-8 bg-gray-100">
                ...
                <div className='flex justify-center'>
                  <FaCheck size={70} className="text-green-600" />
                </div>
                ...
                <button
                  className='primary-btn py-2 px-10 text-lg tracking-wider font-semibold rounded-md text-white bg-green-600 shadow-lg hover:bg-green-400 focus:outline-none'
